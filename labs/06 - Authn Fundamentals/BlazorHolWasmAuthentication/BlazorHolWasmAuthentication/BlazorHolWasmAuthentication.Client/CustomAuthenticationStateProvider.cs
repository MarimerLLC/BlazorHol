...
{
    private static AuthenticationState AuthenticationState { get; set; } =
        new AuthenticationState(new ClaimsPrincipal());
    private static DateTimeOffset? CacheExpire;
    private readonly static Mutex _mutex = new Mutex(false);
